...
- **Sidebar** with search (`⌘K`), collapsible **groups** (folders). Drag notes to reorder or move between groups; `⌘⇧E` focuses the list (↑↓ move, ⌥↑↓ reorder / move across groups, Space or ← → fold, ⌫ deletes with confirmation, Esc back).
